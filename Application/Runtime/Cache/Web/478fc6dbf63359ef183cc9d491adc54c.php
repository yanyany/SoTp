...
<head>
    ...
    <link rel="stylesheet" href="/Public/Web/css/zhuce_qy.css" />
    <script type="text/javascript" src="/Public/Web/js/jsAddress.js"></script>
</head>
<body>
<div id="container">
    <div id="header">
...
<script type="text/javascript" src="/Public/Web/js/jquery/jquery.js"></script>
