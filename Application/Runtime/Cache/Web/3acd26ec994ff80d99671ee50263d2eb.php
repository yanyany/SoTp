...
<div id="body-wrapper">
	...
	<div id="header" class="container clearfix">
		...
		<ul id="navigation">
			...
			<li>
				<a href="./portfolio_4_col.html">我的作品</a>
				<ul>
			...
			<li>
				<a href="./contact.html">我的投递</a>
			</li>
			<li>
				<a href="./contact.html">我的账号</a>
				<ul>
					<li><a href="/web/login/index">登录</a></li>
					<li><a href="/web/login/reg">注册</a></li>
				</ul>
			</li>
		</ul>
		<!-- /Navigation -->
	...
	<div id="content" class="container clearfix">
		...
		<div id="project-wrapper" class="clearfix">
			...
			<div class="section-title one-fourth" style="float: right;margin-top: -211px;text-align: right">
				<h4>Latest Work</h4>
				<p>Phasellus id augue ligula, nec ultrices augue. Aliquam erat volutpat.</p>
				<p><a href="./portfolio_4_col.html">View more projects</a></p>
				<div class="carousel-nav" style="    float: right;">
					<a id="project-prev" class="jcarousel-prev" href="./index.html"></a>
					<a id="project-next" class="jcarousel-next" href="./index.html"></a>
				</div>
			</div>
	...
	<div id="footer">
		...
		<div class="info container clearfix">
			...
			<!-- Copyright -->
			<ul class="copyright">
				<li>© 2012 REWORK MEDIA. All rights reserved. Collect from <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a></li>
